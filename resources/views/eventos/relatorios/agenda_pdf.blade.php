...
<head>
    <meta charset="UTF-8">
    <title>Relatório de Agenda de Eventos</title>
    <style>
        @page {
...
<body>
    <div class="header">
        <div class="header-copy">
            ...
            <p><strong>Escopo:</strong> {{ $periodo }}</p>
    ...
    @empty
        <div class="empty">Nenhum evento futuro foi encontrado para os filtros selecionados.</div>
    @endforelse
